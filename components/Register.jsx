        ...
        <div className="h-screen w-screen bg-onyx flex items-center justify-center">
            <div className="w-full max-w-md px-8">
                <div className="mb-10 text-center">
                    ...
                    <p className="text-text-secondary text-sm mt-2">Get started with your free account</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        <label htmlFor="username" className="block text-text-secondary text-xs font-medium mb-2 uppercase tracking-wider">
                            Username
                        </label>
                ...
                <div className="mt-8 text-center">
                    ...
                    <Link to="/login" className="text-accent text-sm font-medium hover:text-accent-light transition-colors">
                        Sign in
                    </Link>
                </div>
            </div>
